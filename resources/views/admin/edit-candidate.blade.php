        ...
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white">Edit Candidate</h2>
                        <p class="text-purple-100 text-sm mt-1">Update candidate information and campaign details
                        </p>
                    </div>
                </div>
        ...
        <form action="{{ route('candidate-edit', $candidate->id) }}" class="p-8" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-8">
                ...
                <div class="flex items-center gap-6">
                    <div class="relative">
                        <div
                            class="w-24 h-24 rounded-full bg-gradient-to-br from-white to-black flex items-center justify-center text-white text-3xl font-bold shadow-lg">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="mat_no" value="{{ $candidate->mat_no }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                    ...
                    <div>
                        ...
                        <select name="level"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition">
                            <option value="{{ $candidate->level }}">{{ $candidate->level }}</option>
                            @php
                                $levels = [
                                    100,
                                    200,
