<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            {{-- ✅ Success Message --}}
            @if($emailMessage)
                <div class="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg text-green-700 text-sm font-medium text-center">
                    ✅ {{ $emailMessage }}
                </div>
            @endif
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-800">Election Login</h2>
            ...
            <div class="space-y-4">
                ...
                @if($isAdmin)
                    <div class="animate-fadeIn">
                        ...
                        @error('password')
                            <div class="flex items-center gap-2 p-3 mt-2 bg-red-50 border border-red-200 rounded-lg animate-shake">
