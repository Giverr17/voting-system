            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            type="text"
                            wire:model.live.debounce.800ms="identifier"
                            {{-- ✅ Fixed: Correct syntax with longer debounce --}}
                        ...
                        >
                        {{-- Loading indicator --}}
                        <div wire:loading wire:target="identifier" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                    ...
                    <div class="animate-fadeIn">
                        ...
                        <div class="relative">
                            ...
                            <input
                                type="text"
                                wire:model="code"
                                class="w-full pl-10 pr-4 py-3 border-2 border-green-200 bg-green-50 text-green-800 font-mono text-center tracking-widest text-lg rounded-lg cursor-not-allowed"
                                readonly
                            >
                        </div>
